...
// Tic-Tac-Toe-Using-SDL was started, and nothing else.
//
...
#ifndef TIC_TAC_TOE_USING_SDL_USAGE_REPORTING_H
#define TIC_TAC_TOE_USING_SDL_USAGE_REPORTING_H
...
static const char *const PROGRAM_NAME = "Tic-Tac-Toe-Using-SDL";
...
// copy of the program).
static const char *const KEY = "U42dtoVvE_UbJa-umB5lCMZ7Sz75GQfW3llyGNceGi4";
...
static const char *const ENV_ENDPOINT = "TIC_TAC_TOE_USING_SDL_USAGE_REPORTING_ENDPOINT";
...
/**
 * Where the settings file lives: %APPDATA%\Tic-Tac-Toe-Using-SDL on Windows,
 * ~/Library/Application Support/Tic-Tac-Toe-Using-SDL on macOS, and
 * $XDG_CONFIG_HOME/Tic-Tac-Toe-Using-SDL (default ~/.config/Tic-Tac-Toe-Using-SDL) elsewhere.
...
#if defined(TIC_TAC_TOE_VERSION)
    return TIC_TAC_TOE_VERSION;
#else
